       ...
       //Une modification des informations du compte a ete faite
		if(req.getParameter("enregistrer")!=null){
    	    ...
    	    */
			...
			if(req.getParameter("transport")==null){
				
			}
			else if(req.getParameter("transport").equals("tan")){
				...
				if (choix_depart && choix_arrivee && utilisateur.getCalendrier().getHeure_reveil()!=null){
					utilisateur.getTrajet().requeteTrajet(utilisateur.getCalendrier().getHeure_reveil());
				}
			}
			else{
				utilisateur.getTrajet().enregistrer_google_trajet(req.getParameter("transport"), req.getParameter("depart"), req.getParameter("arrivee"), req.getParameter("itineraire"), utilisateur.getCalendrier().getHeure_reveil());
			}
       }
